...
public class SettingsViewModel : BaseViewModel
{
    ...
    private void BrowseRobloxFolder()
    {
        ...
        if (dialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
        {
            ...
            {
                MessageBox.Show("RobloxPlayerBeta.exe was not found in that folder.", "Fracture",
    ...
    private void ExportAccounts()
    {
        ...
        if (accounts.Count == 0)
        {
            MessageBox.Show("No accounts to export.", "Fracture", MessageBoxButton.OK, MessageBoxImage.Information);
            return;
        }
        ...
        var dialog = new Microsoft.Win32.SaveFileDialog
        {
            ...
            Filter = "Fracture Export (*.fracture)|*.fracture",
            FileName = "fracture_accounts.fracture",
        };
        ...
        if (dialog.ShowDialog() == true)
        {
            try
            {
                ...
                MessageBox.Show($"Exported {accounts.Count} account(s) successfully.", "Fracture",
                    MessageBoxButton.OK, MessageBoxImage.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Export failed: {ex.Message}", "Fracture",
    ...
    private void ImportAccounts()
    {
        var dialog = new Microsoft.Win32.OpenFileDialog
        {
            ...
            Filter = "Fracture Export (*.fracture)|*.fracture|All Files (*.*)|*.*",
        };
        ...
        if (dialog.ShowDialog() == true)
        {
            try
            {
                ...
                if (imported.Count == 0)
                {
                    MessageBox.Show("No accounts found in file.", "Fracture",
                        MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }
            ...
            {
                MessageBox.Show($"Import failed: {ex.Message}", "Fracture",
                    MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
    }
