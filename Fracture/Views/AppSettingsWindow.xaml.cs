...
public partial class AppSettingsWindow : Window
{
    ...
    private void OnSaveClick(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show("Please enter a name.", "Fracture", MessageBoxButton.OK, MessageBoxImage.Warning);
            return;
        }

        if (string.IsNullOrEmpty(exePath))
        {
            MessageBox.Show("Please select an executable.", "Fracture", MessageBoxButton.OK, MessageBoxImage.Warning);
            return;
        }
